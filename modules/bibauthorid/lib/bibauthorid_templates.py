...
#                            % (color, color, color, name[0]))
    ...
    def tmpl_update_hep_name(self, full_name, display_name, email,
        ...
        html.append("""<H4>Changes to Existing Records</H4>
                        ...
                        easy for you, and hard for a SPAM robot. Cutting down on the extraneous submissions we get means that we can handle real requests faster.</font></span></td><td><span id="captcha" style="width:100%%;" class="span_float_left">
                        <br /><STRONG> How many people in image</STRONG>  <SELECT NAME=beatspam ID=beatspam> <OPTION VALUE=""> </OPTION>
